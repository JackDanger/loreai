 ...
 *
 * Provides a `whichSync` function that finds an executable in the system
 * PATH, replacing direct `Bun.which()` calls so the same code works under
 * both Bun and the Node.js npm distribution.
 */
